...
in \gls{wrf-hydro} and a required language extension; Section~\ref{sec:conclusions} summarizes our conclusions and future work plans.
...
The \texttt{team\_type} variable has private components.
The \texttt{form team} statement takes an \texttt{team\_number} argument uniquely identifying the team and
a \texttt{team\_type} argument storing all other information about the team.
...
We will investigate restructuring the code to share model initialization
