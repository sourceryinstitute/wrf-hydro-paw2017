...
\gls{pgas} data structures such as \glspl{coarray}.  The upcoming Fortran 2018 standard
...
(e.g.,  climate models).
Such a feature, called \textit{Teams} in the Committee Draft of the Fortran 2018 standard, can significantly
...
\begin{figure}
\includegraphics[width=0.4\textwidth]{figures/init_timing_linear.png}
\vspace{-7pt}
...
We demonstrated the application of Fortran 2018 teams to the problem of ensemble
...
for Fortran 2018 teams.  Importantly, this use case did obviates the need for modifying
